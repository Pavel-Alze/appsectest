...
Напишите список уточняющих вопросов, которые вы бы задали разработчикам данного сервиса?
  ...
  `По данному заданию у меня возникли трудности, из-за отсутствия опыта работы с подобными заданиями и в принципе моделями. Я попытался разобраться, но не уверен, что мои дальнейшие ответы являются теми, что требуется в задании.`


 1. С точки зрения организации структуры сервиса, возможно стоит разбить центральный узел backend сервисов на отдельные узлы, под соответствующие задачи. Например, чтобы распределить нагрузку на соответствующие узлы. Также в некоторых статьях и пособиях предлагают использовать дополнительный слой для очереди заявок. Это может уменьшить временя обслуживания одной заявки и сбалансировать нагрузку на систему.

 2. Стоит учитывать безопасность передачи данных и использование соответствующих протоколов и средств. Необходима работа над уязвимостями, возникающими в ходе самой работы, решением для этого служит обработка передаваемых данных (WAF) на одной из сторон (front или back)
